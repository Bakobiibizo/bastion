...
Outputs:
  Step1WaitTwoMinutes:
    Description: "STEP 1: Wait ~2 minutes for the server to start up"
    Value: "The relay server downloads a pre-compiled binary and starts quickly."
