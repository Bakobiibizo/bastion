...
pub async fn add_contact_from_string(
    ...
    // The public key in contact strings is double-base64-encoded:
    // base64(base64(32 raw bytes)). Decode both layers.
    ...
    // The x25519 key in contact strings is double-base64-encoded:
    // base64(base64(32 raw bytes)). Decode both layers.
